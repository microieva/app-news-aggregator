            ...
            <div className="flex flex-row bg-[var(--np-foreground)] rounded-br-md h-full items-center pl-4">
              ...
              {!loadingHeader &&  currentDate ? 
               <div className="flex flex-col px-4">
                  ...
                  <p className="text-gray-600 text-extrasmall" suppressHydrationWarning>
  ...
  const GridHeaderBottom = () => {
    return (
      <div className="grid-header-bottom">
          <div className="row-start-1 col-start-1 flex items-center bg-[var(--np-background)] rounded-br-md relative z-50 h-full">
            <Dropdown options={sources} />
          </div>

          <div className="row-start-1 col-start-2 rounded-bl-md rounded-tr-md bg-[var(--np-background)] overflow-x-auto">
            <div className="group/tablist relative overflow-x-auto scrollbar-hide h-full w-max min-w-full">
              <div 
                role="tablist" 
                className={clsx(
              ...
              <div className={clsx(
                ...
                <form className="w-full h-full">
                  <input
                    ...
                    className={clsx(
                      "placeholder:text-gray-400 opacity-0 w-full h-full px-3 py-2 bg-[var(--np-background)] rounded-bl-md rounded-tr-md transition-all duration-200 focus:outline-none",
                      {
