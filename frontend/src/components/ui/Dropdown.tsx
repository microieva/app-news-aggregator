  ...
  return (
    <div className="dropdown dropdown-hover w-full dropdown-end relative z-50">
      <div 
        ...
        tabIndex={0} 
        role="button" 
        className="flex bg-background content-center items-center justify-between px-4 py-2"
      >
        {source ? <p>source: {source}</p> : <p>source</p>}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-6 hidden lg:block">
