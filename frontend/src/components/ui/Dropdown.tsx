...
export const Dropdown = ({options}: {options:string[]}) =>{
  ...
  return (
    <div className="dropdown dropdown-hover w-full ">
      <div onClick={()=> setOpen(!open)} tabIndex={0} role="button" className="flex bg-[var(--np-background)] content-center items-center justify-between px-4 py-2">
      ...
      {open && <ul tabIndex={0} className="dropdown-content menu w-52 shadow bg-[var(--np-color-primary)] text-[var(--np-background)] rounded-md border border-[var(--np-color-primary)]">
