...
export const WeatherBlock = () => {
  ...
  return (
    <>
       {loading ? 
          <div className="content-center h-full">
              <div className="text-secondary text-center"><div className="loading loading-spinner"></div></div>
          </div>
      :
        <div className="flex flex-row items-start gap-1 md:gap-2 p-2 md:p-4 h-full">
          <div className='border w-full h-full bg-[var(--np-color-primary)]'>
            <CurrentWeather/>
          </div>

          <div className='w-full h-full lg:py-4'>
            <WeeklyForecast/>
          </div>
        </div>
      }
